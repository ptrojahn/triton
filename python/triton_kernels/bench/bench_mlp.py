...
if __name__ == "__main__":
    ...
    batch_sizes_moe = [32, 128, 256, 1024]
    ...
    if world_size > 1:
        ...
        roofline_mlp(batch_sizes_moe, 3072, 5888, 32, 4, quantized_dtypes[0], quantized_dtypes[1], TP=1, EP=1, name="gpt-oss 20b")
